...
ENV VITE_API_URL=$VITE_API_URL VITE_DEMO_MODE=false VITE_LEGAL_PROJECT_NAME=$VITE_LEGAL_PROJECT_NAME VITE_LEGAL_OPERATOR_NAME=$VITE_LEGAL_OPERATOR_NAME VITE_SUPPORT_EMAIL=$VITE_SUPPORT_EMAIL VITE_SUPPORT_TELEGRAM=$VITE_SUPPORT_TELEGRAM VITE_GOOGLE_CLIENT_ID=$VITE_GOOGLE_CLIENT_ID VITE_TELEGRAM_BOT_USERNAME=$VITE_TELEGRAM_BOT_USERNAME
RUN npm run build
